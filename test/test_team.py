...
from model.exceptions import DuplicateOid, DuplicateEmail
...
class TeamTests(unittest.TestCase):
    ...
    def test_sends_email(self, mock_print):
        ...
        t.add_member(tm1)
        t.add_member(tm2)
        t.send_email(Emailer.instance(), "S", "M")
    ...
    def test_string(self):
        ...
        t.add_member(TeamMember(3, "Barney", "barney@bedrock"))
        t.add_member(TeamMember(4, "Wilma", "wima@bedrock"))
        self.assertEqual("Flintstones: 3 members", str(t))

    def test_duplicate_member(self):
        t = Team(1, "Flintstones")
        tm1 = TeamMember(2, "Fred", "fred@bedrock")
        t.add_member(tm1)
        with self.assertRaises(DuplicateOid):
            t.add_member(tm1)

    def test_duplicate_blank(self):
        t = Team(1, "Flintstones")
        tm1 = TeamMember(2, "Fred", "fred@bedrock")
        t.add_member(tm1)
        tm2 = TeamMember(2, "Mark", "zuckerberg@fb")
        with self.assertRaises(DuplicateOid):
            t.add_member(tm2)
    ...
    def test_duplicate_email(self):
        t = Team(1, "Flintstones")
        tm1 = TeamMember(2, "Fred", "fred@bedrock")
        tm2 = TeamMember(3, "Barney", "fred@bedrock")
        t.add_member(tm1)
